...
// paginate for every 10 members in the loans table
$limit = 10;
...
SELECT COALESCE(SUM(total_paid), 0) total
FROM loans
")->fetch_assoc()['total'];

$totalBorrowers = $conn->query("
...
<body>
    ...
    <div class="main">
        ...
        <div class="topbar">
            ...
            <button class="btn-orange" onclick="openLoanModal()">
                + Give Loan
            </button>
        </div>
                ...
                <table>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                K<?php echo number_format($row['amount']); ?>
                            </td>

                            <td>
                                K<?php echo number_format($row['total_paid']); ?>
                            </td>

                            <td>
                                K<?php echo number_format($row['balance']); ?>
                            </td>
